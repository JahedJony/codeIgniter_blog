<div class="box-content">
	<form class="form-horizontal" name="edit_category_form" action="<?php echo base_url(); ?>super_admin/save_blog" method="post">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="span6 typeahead" name="blog_title" id="blog_title" value="" required>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="cleditor" name="blog_short_description" id="blog_short_description" rows="3"></textarea>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="blog_long_description">Blog Long Description</label>
				<div class="controls">
					<textarea class="cleditor" name="blog_long_description" id="blog_long_description" rows="3"></textarea>
				</div>
			</div>
			<div class="control-group">
